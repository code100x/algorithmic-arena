            ...
            <div>
              ...
              <div className="flex items-center text-gray-400 space-x-4">
                <span className="flex items-center">
                  <CalendarIcon className="mr-1" size={16} /> 30 August, 2024,
                  2:00 PM (IST)
                </span>
                <span className="flex items-center">
                  <ClockIcon className="mr-1" size={16} /> 3 hours
                </span>
                <span className="flex items-center">
                  <UsersIcon className="mr-1" size={16} /> 5,000 Participants
                </span>
              </div>
            </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-gray-400">
                  Join our weekly coding contest and compete with programmers
                  from around the world! This contest features a mix of
                  algorithmic problems designed to challenge your coding skills.
                </p>
              </div>
              <div>
          ...
          <Card className="bg-gray-900 border-gray-800">
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-400 mb-4">
                Contest not live yet, explore other active contests.
              </p>
              <Button
                variant="outline"
