...
export function Hero() {
    return <section className="bg-white dark:bg-gray-900 py-8 md:py-12">
    <div className="container mx-auto px-4 md:px-6">
      <div className="grid md:grid-cols-2 gap-8 md:gap-12">
        <div>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Welcome to Code100x</h1>
          <p className="text-gray-500 dark:text-gray-400 mb-6">
            Code100x is a platform for holding programming contests. Participate in challenges, solve problems,
        ...
        <div className="hidden md:block">
          <img src="https://ideogram.ai/assets/image/balanced/response/OZ93FYuyRpmpgNxX0fRMSw" width="600" height="400" alt="Code100x" className="rounded-lg" />
        </div>
      </div>
    </div>
  </section>
