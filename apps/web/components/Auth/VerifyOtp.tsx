...
const CenteredOTPInput: React.FC<CenteredOTPInputProps> = ({ value, onChange }) => {
  ...
  return (
    <Card className="w-[350px] mx-auto">
      ...
      <Image src="/logo.svg" alt="Logo" width={64} height={64} />
        ...
        <CardDescription>Please enter the 4-digit code below to verify your account</CardDescription>
      </CardHeader>
      <CardContent>
