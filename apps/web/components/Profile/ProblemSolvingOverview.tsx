...
//   return (
//     <div className="h-[62px] w-full px-3 py-2 bg-slate-900 rounded-xl flex flex-col justify-center items-center gap-0.5">
//       <div className={`self-stretch text-center text-sm font-medium leading-tight`} style={{ color: fill }}>
//         {difficulty}
//       </div>
//       <div className="self-stretch text-center text-slate-50 text-base font-medium leading-normal">
//         {value}
//       </div>
//     </div>
//   );
...
//   return (
//     <Card className="w-[439px] h-[336px] p-4 bg-[#020817] border-slate-800">
//       <CardHeader className="items-start pb-4">
//         <CardTitle className="text-slate-50 text-xl font-bold">Problem-Solving Overview</CardTitle>
//       </CardHeader>
...
//               value={`${solved} / 25`} // Adjust this value based on actual data or context
//               fill={fill}
//             />
//           ))}
//         </div>
